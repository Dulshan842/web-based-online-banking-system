...
public class MainServelet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        // Default landing page when accessed via browser
        req.getRequestDispatcher("/WEB-INF/it24104176/index.jsp").forward(req, res);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        switch (page) {
            ...
            case "confirm":
                req.getRequestDispatcher("/WEB-INF/it24104176/success.jsp").forward(req, res);
                break;
